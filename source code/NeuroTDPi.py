...
train_data_BBB = pd.read_csv("BBB_7理化性质原始.csv", header=None)
train_data_NC = pd.read_csv("NC_7理化性质原始.csv", header=None)
train_data_NT = pd.read_csv("NT_7理化性质原始.csv", header=None)
