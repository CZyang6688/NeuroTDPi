...
#加载数据集
df_x_test =pd.read_csv("D:\Code\Neuron\BBB\BBB_jingjian\BBB理化性质test-x.csv", na_values=["?", "NA"])
df_y_test = pd.read_csv("D:\Code\Neuron\BBB\BBB_jingjian\BBB理化性质test-y.csv", na_values=["?", "NA"])
...
# 加载模型
model = load_model('/Neuron/BBB/BBB_jingjian/model_BBB理化性质-精简.h5')
