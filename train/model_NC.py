...
df_x_train = pd.read_csv("NC-MACCSS理化性质-x-train.csv", na_values=["?", "NA"])
df_y_train = pd.read_csv("NC-MACCSS理化性质-y-train.csv", na_values=["?", "NA"])
df_x_test =pd.read_csv("NC_test-x.csv", na_values=["?", "NA"])
df_y_test = pd.read_csv("NC-MACCSS理化性质-y-test.csv", na_values=["?", "NA"])
